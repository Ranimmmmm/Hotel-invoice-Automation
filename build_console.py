#!/usr/bin/env python3
"""
Build script to create a standalone Windows executable WITH console window.
This version shows console output (useful for debugging and seeing progress).
...
# Build the executable WITH console window
PyInstaller.__main__.run([
    main_script,
    '--name=%s' % app_name,
    '--onefile',  # Create a single executable file
    '--console',  # Show console window (for debugging and progress)
...
print("[NOTE] This version includes a console window for debugging")
